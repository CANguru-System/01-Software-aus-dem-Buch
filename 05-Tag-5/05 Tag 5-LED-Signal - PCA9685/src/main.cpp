...
LEDSignal Signals[num_signals] = {signal00, signal01, signal02, signal03, signal04, signal05, signal06, signal07};
uint8_t signalDelay;
...
{
  // berechnet die _to_address aus der Adresse und der Protokollkonstante
  uint16_t baseaddress = (params.decoderadr - 1) * 4;
  for (uint8_t signal = 0; signal < num_signals; signal++)
  {
